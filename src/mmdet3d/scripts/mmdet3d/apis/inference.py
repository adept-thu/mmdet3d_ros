...
def inference_multi_modality_detector_yuanshi(model, pcd, image, ann_file):
...
def inference_multi_modality_detector(model, pcd, image):
    ...
    if box_mode_3d == Box3DMode.LIDAR:
        ...
        # # P2 = info['calib']['P2'].astype(np.float32)
        # lidar2img = P2 @ rect @ Trv2c
        rect = np.array([[ 1.4660783594681243e+03, 0., 9.4123994010058311e+02,0],[ 0.,
       1.4743622992117732e+03, 5.7505139716312851e+02,0],[ 0., 0., 1.,0 ]])
        Trv2c = np.array([[ -8.1572032423805507e-02, 7.8452938904406966e-02,  9.9357492918426182e-01, -8.3985827863216400e-02],
       [-9.9324601743243168e-01, 7.6132835010752853e-02, -8.7556497690571833e-02, -3.3018329739570618e-01],
       [-8.2512740718408195e-02, -9.9400650290150860e-01, 7.1712759036658746e-02, -1.4617311954498291e-01],
       [ 0., 0., 0., 1.] ])


        lidar2img = rect @ Trv2c
        data['img_metas'][0].data['lidar2img'] = lidar2img
